          ...
          <div className="flex flex-wrap justify-between">
            {tabs.map((tab, idx) => (
              <button
                ...
                className={`px-4 py-5 transition-all duration-300 font-medium ${
                  activeTab === idx
          ...
          >
            <div className="grid lg:grid-cols-12 gap-16">
              <div className="lg:col-span-5">
                <h2 className="text-3xl md:text-5xl font-['Clash_Grotesk'] text-primary mb-8">
                  {activeContent.title}
                </h2>

                <p className="text-slate-800 mb-12 leading-relaxed">
                ...
                <button className="bg-primary text-white px-8 py-4 rounded-md flex items-center gap-3 hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20">
                  {activeContent.cta}
